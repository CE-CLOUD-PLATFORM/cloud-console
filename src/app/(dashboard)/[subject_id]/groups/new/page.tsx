...
import { NewGroupInputs } from "@/interfaces/group";
    ...
    <div className="main">
      ...
      >
        ...
        <TextField
          ...
          label="Cores"
          type="number"
          {...register("cores", { required: true })}
        />
        {errors.cores && <span>This field is required</span>}
        ...
        <TextField
          ...
          label="Instances"
          type="number"
          {...register("instances", { required: true })}
        />
        {errors.instances && <span>This field is required</span>}
